...
@RequestScope
public class ReportProcessorVolumeFormingClientList extends TemplateReportProcessor {

    private SettingHolder settingHolder;

    public ReportProcessorVolumeFormingClientList(@Value(value = ("#{fields}")) Map<String, Map<String, List<String>>> fields, SettingHolder settingHolder) {
        super(fields);
...
/*    @Override
    ...
    protected void generateReport(List<List<String>> data, Map<String, MarketOwner> ownerHashMap, Map<String, Integer> columnNumbers) {
        ...
        for (List<String> linkedList: data){
